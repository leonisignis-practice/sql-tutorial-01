...
-- │1960 │Literature│Saint-John Perse 2960000000 │
...
-- Show all details (yr, subject, winner)
-- of the literature prize winners for 1980 to 1989 inclusive.
SELECT yr,
    subject,
    winner
FROM nobel
...
FROM nobel
WHERE yr = 1984
ORDER BY subject IN ('physics', 'chemistry'), -- valid in MySQL
    subject,
    winner;
